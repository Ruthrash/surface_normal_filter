...
with open('depth_images_sample.json','r') as file_:
...
cv2.imwrite("surface_img.jpg", normal_img)  

component_img = np.zeros((126,126,1),dtype=float)
component_img = normal_output[0,:,:] 
cv2.imwrite("surface_img_component_x.jpg", component_img)  

component_img = normal_output[1,:,:] 
cv2.imwrite("surface_img_component_y.jpg", component_img)  

component_img = normal_output[2,:,:] 
cv2.imwrite("surface_img_component_z.jpg", component_img)  
